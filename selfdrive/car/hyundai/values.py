...
FEATURES = {
  ...
  "use_cluster_gears": {CAR.ELANTRA, CAR.KONA, CAR.ELANTRA_GT_I30, CAR.NIRO_HEV, CAR.GRANDEUR},
  ...
  "use_elect_gears": {CAR.K5_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.NIRO_HEV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.K7_HEV,
                      CAR.GRANDEUR_HEV},
  # Use E_EMS11 Message for Gas and Brake for Hybrid/ELectric
  "use_elect_ems": {CAR.K5_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.NIRO_HEV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.K7_HEV,
                    CAR.GRANDEUR_HEV},
  # send LFA MFA message for new HKG models
  "send_lfa_mfa": {CAR.SONATA, CAR.PALISADE, CAR.SONATA_HEV, CAR.SANTA_FE, CAR.NIRO_EV, CAR.SPORTAGE},
  "has_scc13": {},
  "has_scc14": {},
  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": {CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.STINGER, CAR.IONIQ, CAR.KONA, CAR.KONA_EV, CAR.FORTE,
              CAR.PALISADE, CAR.GENESIS_G70, CAR.SPORTAGE},

  "use_bsm": {CAR.SONATA, CAR.PALISADE, CAR.GENESIS, CAR.NIRO_HEV, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90,
              CAR.GENESIS_G90_L, CAR.KONA, CAR.SPORTAGE},
